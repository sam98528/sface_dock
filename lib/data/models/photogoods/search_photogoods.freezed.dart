...
abstract class $SearchPhotogoodsDataCopyWith<$Res> {
  factory $SearchPhotogoodsDataCopyWith(SearchPhotogoodsData value,
...
/// @nodoc
class _$SearchPhotogoodsDataCopyWithImpl<$Res,
...
abstract class _$$SearchPhotogoodsDataImplCopyWith<$Res>
    implements $SearchPhotogoodsDataCopyWith<$Res> {
  factory _$$SearchPhotogoodsDataImplCopyWith(_$SearchPhotogoodsDataImpl value,
...
class __$$SearchPhotogoodsDataImplCopyWithImpl<$Res>
  ...
  __$$SearchPhotogoodsDataImplCopyWithImpl(_$SearchPhotogoodsDataImpl _value,
  ...
  $Res call({
    ...
    return _then(_$SearchPhotogoodsDataImpl(
      data: null == data
          ? _value._data
          : data // ignore: cast_nullable_to_non_nullable
              as List<SearchPhotogoods>,
...
class _$SearchPhotogoodsDataImpl implements _SearchPhotogoodsData {
  ...
  Map<String, dynamic> toJson() {
    return _$$SearchPhotogoodsDataImplToJson(
      this,
    );
  }
}
...
abstract class $SearchPhotogoodsCopyWith<$Res> {
  factory $SearchPhotogoodsCopyWith(
          SearchPhotogoods value, $Res Function(SearchPhotogoods) then) =
...
abstract class _$$SearchPhotogoodsImplCopyWith<$Res>
    implements $SearchPhotogoodsCopyWith<$Res> {
  factory _$$SearchPhotogoodsImplCopyWith(_$SearchPhotogoodsImpl value,
...
class __$$SearchPhotogoodsImplCopyWithImpl<$Res>
  ...
  __$$SearchPhotogoodsImplCopyWithImpl(_$SearchPhotogoodsImpl _value,
  ...
  $Res call({
    ...
    return _then(_$SearchPhotogoodsImpl(
      feedsIdx: null == feedsIdx
          ? _value.feedsIdx
          : feedsIdx // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$SearchPhotogoodsImpl implements _SearchPhotogoods {
  const _$SearchPhotogoodsImpl(
      ...
      @JsonKey(name: 'feeds_img_attach')
      required final List<int> feedsImgAttach,
      @JsonKey(name: 'feeds_thumbnail_attach')
      required this.feedsThumbnailAttach})
  ...
  @override
  Map<String, dynamic> toJson() {
    return _$$SearchPhotogoodsImplToJson(
      this,
    );
  }
}
...
abstract class _SearchPhotogoods implements SearchPhotogoods {
  const factory _SearchPhotogoods(
      ...
      required final List<int> feedsImgAttach,
      @JsonKey(name: 'feeds_thumbnail_attach')
      required final String feedsThumbnailAttach}) = _$SearchPhotogoodsImpl;
